    ...
    >
      <div class="dialog-content">
        ...
        >
          ...
          <!-- Web/移动端配置 -->
          <template v-if="newItem.type === 'web' || newItem.type === 'mobile'">
            <el-form-item label="URL" prop="url">
              <el-input v-model="newItem.url" placeholder="http://localhost:3000" />
            </el-form-item>
            <el-form-item label="项目路径">
              <el-input v-model="newItem.projectPath" placeholder="projects/my-project" />
            </el-form-item>
            <el-form-item v-if="newItem.type === 'mobile'" label="视口尺寸">
          ...
          <template v-if="newItem.type === 'doc'">
            <el-form-item label="文档路径" prop="docPath">
              <el-input v-model="newItem.docPath" placeholder="path/to/doc.md" />
            </el-form-item>
          </template>
...
async function handleAddItem() {
  try {
    ...
    if (newItem.type === 'web' || newItem.type === 'mobile') {
      item.url = newItem.url
      item.projectPath = newItem.projectPath
      if (newItem.type === 'mobile') {
