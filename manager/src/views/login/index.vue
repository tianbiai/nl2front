  ...
  <div class="login-page" ref="pageRef">
    ...
    <div class="login-container">
      ...
      <div class="brand-section">
        ...
        <h1 class="brand-title">项目管理聚合基座</h1>
        <p class="brand-subtitle">统一管理多个前端项目</p>

        <div class="feature-list">
          <div class="feature-item">
            <span class="feature-icon">🎯</span>
            <span class="feature-text">项目聚合管理</span>
          </div>
          <div class="feature-item">
            <span class="feature-icon">📄</span>
            <span class="feature-text">设计文档查看</span>
          </div>
        </div>
      </div>
    ...
    <!-- 底部版权 -->
    <div class="footer">
      <p>© 2024 项目管理基座 · Powered by Vue 3</p>
    </div>
      ...
      <div v-if="showLoading" class="fullscreen-loading">
        <div class="loading-content">
          <div class="loading-logo">
            <el-icon :size="48" color="var(--primary-color)"><Grid /></el-icon>
          </div>
...
import { User, Lock, ArrowRight, Grid } from '@element-plus/icons-vue'
